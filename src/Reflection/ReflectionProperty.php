...
class ReflectionProperty
{
    ...
    public static function importFromCache(Reflector $reflector, array $data, LocatedSource $locatedSource): self
    {
        ...
        $ref->immediateHooks = array_map(
            static fn ($hookData) => ReflectionMethod::importFromCache($reflector, $hookData, $locatedSource),
            $data['immediateHooks'],
        );
     ...
     * @param ReflectionPropertyHookType::* $hookType
     */
    public function getHook(string $hookType): ?\Roave\BetterReflection\Reflection\ReflectionMethod
    {
    ...
    private function getParentProperty(): ?\Roave\BetterReflection\Reflection\ReflectionProperty
    {
