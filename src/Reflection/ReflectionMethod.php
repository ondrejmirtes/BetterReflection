...
class ReflectionMethod
{
    ...
    /**
     * @param \PHPStan\BetterReflection\Reflection\ReflectionNamedType|\PHPStan\BetterReflection\Reflection\ReflectionUnionType|\PHPStan\BetterReflection\Reflection\ReflectionIntersectionType|null $type
     */
    private function typeUsesStatic($type): bool
    {
        if ($type === null) {
            return false;
        }
