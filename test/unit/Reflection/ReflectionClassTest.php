...
PHP;
    ...
    {
        $reflector = new DefaultReflector(new SingleFileSourceLocator(__DIR__ . '/../Fixture/AnonymousClassInstanceWithParentDefinedLater.php', $this->astLocator));
    ...
    {
        $reflector = new DefaultReflector(new SingleFileSourceLocator(__DIR__ . '/../Fixture/ClassUsesUnknownTrait.php', $this->astLocator));

        self::assertSame([], $reflector->reflectClass(Fixture\ClassUsesUnknownTrait::class)->getTraitAliases());
    }
    ...
    {
        $reflector = new DefaultReflector(new SingleFileSourceLocator($sourcePath, $this->astLocator));

        self::assertSame($expectedTraits, $reflector->reflectClass($className)->getTraitClassNames());
    }
    ...
    {
        $reflector = new DefaultReflector(new SingleFileSourceLocator(__DIR__ . '/../Fixture/TraitFixtureWithFinal.php', $this->astLocator));
