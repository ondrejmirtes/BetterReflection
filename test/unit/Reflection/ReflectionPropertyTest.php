...
class ReflectionPropertyTest extends TestCase
{
    ...
    public function testCreateFromNodeWithNotPromotedProperty(): void
    {
        ...
        $property             = ReflectionProperty::createFromNode($this->reflector, new Property(Modifiers::PUBLIC, [$propertyPropertyNode]), $propertyPropertyNode, $classInfo, $classInfo);
    ...
    public function testCreateFromNodeWithPromotedProperty(): void
    {
        $classInfo            = $this->reflector->reflectClass(ExampleClass::class);
        $propertyPropertyNode = new PropertyItem('foo');
        $property             = ReflectionProperty::createFromNode($this->reflector, new Property(Modifiers::PUBLIC, [$propertyPropertyNode]), $propertyPropertyNode, $classInfo, $classInfo, true);
    ...
    public function testIsDefaultWithRuntimeDeclaredProperty(): void
    {
        $classInfo            = $this->reflector->reflectClass(ExampleClass::class);
        $propertyPropertyNode = new PropertyItem('foo');
        $propertyNode         = ReflectionProperty::createFromNode($this->reflector, new Property(Modifiers::PUBLIC, [$propertyPropertyNode]), $propertyPropertyNode, $classInfo, $classInfo, false, false);
...
PHP;
    ...
    public function testIsInitialized(string $propertyName, $object, bool $isInitialized): void
    {
