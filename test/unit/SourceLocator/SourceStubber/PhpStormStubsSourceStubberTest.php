...
class PhpStormStubsSourceStubberTest extends TestCase
{
    ...
    public static function dataClassConstantInPhpVersion(): array
    {
        return [
            ...
            [PDO::class, 'FETCH_DEFAULT', 80000, true],
            [PDO::class, 'FETCH_DEFAULT', 70499, false],
            [ZipArchive::class, 'LIBZIP_VERSION', 70400, true],
            [ZipArchive::class, 'LIBZIP_VERSION', 70399, false],
        ];
    }
    ...
    public static function dataMethodInPhpVersion(): array
    {
        return [
            ...
            [DatePeriod::class, 'getRecurrences', 70199, false],
            [DatePeriod::class, 'getRecurrences', 70200, true],
    ...
    public static function dataFunctionInPhpVersion(): array
    {
        return [
            ...
            ['hash_hkdf', 70099, false],
            ['hash_hkdf', 70100, true, 'string|false'],
    ...
    {
        $sourceStubber = new PhpStormStubsSourceStubber($this->phpParser, $this->prettyPrinter, 70400);
    ...
    public static function dataConstantInPhpVersion(): array
    {
        return [
            ...
            ['CURL_VERSION_ALTSVC', 70300, true],
            ['CURL_VERSION_ALTSVC', 70299, false],
            // Not core constants
